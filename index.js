...
// const arrTiay = ["tuananh", "nguyen", 2002, "frontEndDev", 79202006955, true];
// console.log("----- ONLY STRINGS -----");
// for (let i = 0; i < arrTiay.length; i++) {
//   if (typeof arrTiay[i] !== "string") continue;
//   console.log(arrTiay[i]); 
// }

// const objStr = [];
// const number = [];
// for (let eleObj = 0; eleObj < objTiay.length; eleObj++) {
//   if (typeof objTiay[eleObj] === "string") objStr.push(objTiay[eleObj]);
//   if (typeof objTiay[eleObj] === "number") number.push(objTiay[eleObj]);
